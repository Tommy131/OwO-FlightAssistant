...
const rules = [
  ...
  },
  {
    ...
    appliesTo: (path) =>
      ...
      /(approach-beam|holding-geometry|papi-guidance|airport-outline|map-airport-parser|map-response-parsers|planned-route-parser|procedure-parser|geo|metar-decode)\.ts$/.test(
        path,
      ),
