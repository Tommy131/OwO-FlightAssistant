          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text(
                  '${log.points.length} ${FlightLogsLocalizationKeys.blackBoxRows.tr(context)}',
          ...
          SingleChildScrollView(
            ...
            child: DataTable(
              ...
              columns: [
                ...
                DataColumn(
                  label: Text(
                    FlightLogsLocalizationKeys.blackBoxGroundSpeed.tr(context),
                  ),
                ),
                DataColumn(
                  label: Text(
              ...
              rows: log.points
                  .map(
                    (p) => DataRow(
                      cells: [
                        DataCell(Text(timeFormat.format(p.timestamp.toLocal()))),
