            ...
            children: [
              _buildStatusSection(
                ...
                [
                  ...
                  if (data.fireWarningEngine1 == true)
                    StatusBadge(
                      label: HomeLocalizationKeys.systemFireEngine1.tr(context),
                      color: fireColor,
                    ),
                  if (data.fireWarningEngine2 == true)
                    StatusBadge(
                      label: HomeLocalizationKeys.systemFireEngine2.tr(context),
                      color: fireColor,
                    ),
              ...
              _buildStatusSection(
                ...
                [
                  ...
                  if (showSecondEngine && data.engine1Running == true)
                    StatusBadge(
                      label: HomeLocalizationKeys.systemEngineLeft.tr(context),
                      color: engineColor,
                    ),
                  if (showSecondEngine && data.engine2Running == true)
                    StatusBadge(
                      label: HomeLocalizationKeys.systemEngineRight.tr(context),
                      color: engineColor,
                    ),
              ...
              _buildStatusSection(
                ...
                [
                  ...
                  if (data.logoLights == true)
                    StatusBadge(
                      label: HomeLocalizationKeys.systemLogoLights.tr(context),
                      color: logoLightsColor,
                    ),
                  if (data.wingLights == true)
                    StatusBadge(
                      label: HomeLocalizationKeys.systemWingLights.tr(context),
                  ...
                  if (data.taxiLights == true)
                    StatusBadge(
                      label: HomeLocalizationKeys.systemTaxiLights.tr(context),
